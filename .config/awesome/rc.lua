...
mymembar:set_color({type = "linear", from = {0, 0}, to = {0, 18}, stops = { { 0, "#285577" }, { 0.5, "#AEC6D8" }, { 1, "#333333" } }})

mycpugraph:set_background_color( '#333333' )
mycpugraph:set_border_color( '#0a0a0a' )
mycpugraph:set_color({type = "linear", from = {0, 0}, to = {0, 18}, stops = { { 0, "#285577" }, { 0.5, "#AEC6D8" }, { 1, "#333333" } }})

mynetgraph:set_background_color( '#333333' )
mynetgraph:set_border_color( '#0a0a0a' )
mynetgraph:set_color({type = "linear", from = {0, 0}, to = {0, 18}, stops = { { 0, "#285577" }, { 0.5, "#AEC6D8" }, { 1, "#333333" } }})
